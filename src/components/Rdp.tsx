        ...
        <div className="w-full h-full flex flex-col bg-black relative overflow-hidden">
          <div className="h-8 bg-zinc-900/80 border-b border-zinc-800 flex items-center justify-between px-3 shrink-0 z-10">
            <div className="flex items-center gap-2 text-xs text-zinc-400 min-w-0">
              ...
              <span className="text-zinc-500 shrink-0">({requestedSizeRef.current.width}x{requestedSizeRef.current.height})</span>
            </div>
            <button
              onClick={handleDisconnect}
              className="flex items-center gap-1.5 text-xs text-zinc-400 hover:text-red-400 transition-colors px-2 py-1 rounded hover:bg-zinc-800"
            >
        ...
        <div className="w-full h-full flex flex-col items-center justify-center gap-6">
          ...
          <div className="text-center max-w-md space-y-2">
            ...
            {state === 'error' ? (
              ...
              <p className="text-sm text-zinc-400">Session disconnected. Click to reconnect.</p>
            ) : (
          ...
          <div className="flex flex-col gap-3 w-72">
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 bg-zinc-900 text-zinc-400 py-2.5 rounded-md text-sm font-medium border border-zinc-800 cursor-not-allowed opacity-70"
            >
            ...
            {state === 'error' && (
              <div className="mt-2 p-3 bg-zinc-900 border border-zinc-800 rounded-md text-xs text-zinc-400 space-y-1">
